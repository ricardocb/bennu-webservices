...
<div class="page-header">
	<h1>
		<spring:message code="label.management.keystores.updateDomainKeyStore" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	<a class=""
		href="${pageContext.request.contextPath}/webservices/management/keystores/domainkeystore/read/${domainKeyStore.externalId}"><span
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group row" id="oldPasswordField">
				...
				<div class="col-sm-10">
					<input id="domainKeyStore_oldPassword" class="form-control"
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input id="domainKeyStore_passwordVerification" class="form-control"
