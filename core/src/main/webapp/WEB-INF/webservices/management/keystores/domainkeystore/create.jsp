...
<div class="page-header">
	<h1>
		<spring:message code="label.management.keystores.createDomainKeyStore" />
		<small></small>
	</h1>
</div>
...
<form method="post" class="form-horizontal">
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.DomainKeyStore.password" />
				</div>

				<div class="col-sm-10">
					<input id="domainKeyStore_password" class="form-control"
						type="password" name="password"
						value='<c:out value='${not empty param.password ? param.password : domainKeyStore.password }'/>' required/>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.passwordVerification" />
				</div>

				<div class="col-sm-10">
					<input id="domainKeyStore_passwordVerification"
						class="form-control" type="password" name="passwordVerification"
						value='<c:out value='${not empty param.passwordVerification ? param.passwordVerification : domainKeyStore.password }'/>' required/>
				</div>
			</div>
		</div>
