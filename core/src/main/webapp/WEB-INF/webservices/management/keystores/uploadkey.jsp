...
<div class="page-header">
	<h1>
		<spring:message code="label.management.keystores.uploadKey" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	...
	<a class=""
		href="${pageContext.request.contextPath}/webservices/management/keystores/uploadkey/cancel/${domainKeyStore.externalId}"><span
		class="glyphicon glyphicon-cog" aria-hidden="true"></span>&nbsp;<spring:message
			code="label.event.management.keystores.cancel" /></a>
</div>
...
<form method="post" class="form-horizontal"
	action="${pageContext.request.contextPath}/webservices/management/keystores/uploadkey/upload/${domainKeyStore.externalId}"
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<c:out value="${domainKeyStore.name}" />
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.DomainKeyStore.alias" />
				</div>

				<div class="col-sm-10">
					<input id="domainKeyStore_keyAlias" class="form-control"
						type="text" name="keyAlias" value='' />
				</div>
			</div>

			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.DomainKeyStore.keyPassword" />
				</div>

				<div class="col-sm-10">
					<input id="domainKeyStore_keyPassword" class="form-control"
						type="password" name="keyPassword" value='' />
				</div>
			</div>

			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.DomainKeyStore.keyFile" />
				</div>

				<div class="col-sm-10">
					<input id="domainKeyStore_keyFile" class="form-control"
						type="file" name="keyFile" value='' />
				</div>
			</div>
		</div>
