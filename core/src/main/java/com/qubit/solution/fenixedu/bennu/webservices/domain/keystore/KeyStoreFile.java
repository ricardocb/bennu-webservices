...
public class KeyStoreFile extends KeyStoreFile_Base {

	protected KeyStoreFile() {
		super();
	}

	protected KeyStoreFile(DomainKeyStore domainKeyStore, byte[] content) {
		this();
		init(domainKeyStore.getName(), domainKeyStore.getName(), content);
	}

	public boolean isAccessible(org.fenixedu.bennu.core.domain.User arg0) {
		return false;
	}
