...
@BennuSpringModule(basePackages = "com.qubit.solution.fenixedu.bennu.webservices", bundles = "WebservicesResources")
public class BennuWebservicesSpringConfiguration {
}
